...
/**
 * PeriodoController implementación de las acciones CRUD en base al modelo Periodo model.
 */
class PeriodoController extends Controller {
    ...
    /**
     * Muestra un modelo Periodo basado en su valor de clave principal.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Actualiza el modelo Periodo basado en su valor de clave principal.
    ...
    public function actionModificar($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('info', \app\helpers\HelperPersonalizado::MENSAJE_EXITO);
            return $this->redirect(['ver', 'id' => $model->id]);
        } else {
    ...
    /**
     * Elimina el modelo Periodo basado en su valor de clave principal.
    ...
    /**
     * Busca el modelo Periodo basado en su valor de clave principal.
     * Si no se encuentra el modelo, se lanzará una excepción de 404 HTTP.
     * @param integer $id
     * @return Periodo retorna el modelo cargado
