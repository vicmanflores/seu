...
$(document).on(event,selector,callback);gridEventHandlers[id][type]={event:event,selector:selector};}})(window.jQuery);;function LlamarModal(){$valor=$("#frmingresarcedula-cedula").val();$('#Creando').hide();$('#Generando').hide();$('#Comprobando').hide();$('#Enviando').hide();if($valor!=""){$('#modal-espera-envio-correo').modal('show')
