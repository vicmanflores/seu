<?php
/**
 * @author    DesingTechx S.A <info@designtechx.com>
 * @copyright Copyright &copy; DesingTechx S.A, designtechx.com, 2016 - 2017
 * @version   1.0
 */
...
* @return mixed
*/
    public function actionModificar(<?= $actionParams ?>)
    {
        $model = $this->findModel(<?= $actionParams ?>);
